...
<link href="{{ asset('frontend/fonts/fontawesome/css/fontawesome-all.min.css') }}" rel="stylesheet" type="text/css">
<link href="{{ asset('frontend/plugins/fancybox/fancybox.min.css') }}" rel="stylesheet" type="text/css">
