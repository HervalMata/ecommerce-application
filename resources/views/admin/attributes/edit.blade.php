        ...
        <div class="col-md-3">
            <div class="title p-0">
                <ul class="nav flex-column nav-tabs user-tabs">
                    ...
                    <li class="nav-item"><a class="nav-link" href="#values" data-toggle="tab">Atributos</a></li>
                </ul>
            </div>
        </div>
        <div class="col-md-9">
                        ...
                        <form action="{{ route('admin.attributes.update') }}" method="POST" role="form">
                            ...
                            <div class="tile-body">
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('code') is-invalid @enderror" type="text" name="code" id="code" value="{{ old('code', $attribute->code) }}">
                                </div>
                                <input type="hidden" name="id" value="{{ $attribute->id }}">
                                <div class="form-group">
                                    <label class="control-label" for="name">Nome <span class="m-1-5 text-danger"> *</span> </label>
                                    <input class="form-control @error('name') is-invalid @enderror" type="text" name="name" id="name" value="{{ old('name', $attribute->name) }}">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="checkbox" name="is_erquired" id="is_erquired"
                            ...
                            <div class="tile-footer">
                                <div class="row d-print-none mt-2">
                                    <div class="col-12 text-right">
                                        <button class="btn btn-primary" type="submit"><i class="fa fa-fw fa-lg fa-check-circle">Atualizar Atributo</i> </button>
                                        $nbsp;$nbsp;$nbsp;
                                        <a class="btn btn-secondary" href="{{ route('admin.attributes.index') }}"><i class="fa fa-fw fa-lg fa-times-circle"></i>Retornar </a>
                                    </div>
                                </div>
                            </div>
                        </form>
...
@push('scripts')
<script>
    import AttributeValues from "../../../js/components/AttributeValues";
    export default {
        components: {AttributeValues}
    }
</script>
@endpush
