...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => ['auth:admin']], function () {
        ...
        Route::post('/settings', 'Admin\SettingController@index')->name('admin.settings.update');
        ...
        Route::group(['prefix' => 'attributes'], function () {
            ...
            Route::post('attributes/add', 'Admin\ProductAttributeController@paddAttribute');
        ...
        Route::group(['prefix' => 'orders'], function () {
            Route::get('/', 'Admin\OrrderController@index')->name('admin.orders.index');
            Route::get('/{order}/show', 'Admin\OrrderController@show')->name('admin.orders.show');
        });
    });
});
